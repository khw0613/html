...
%>
	<form id="frm" name="frm" method="POST" action="13_EMP_UPD_ACT.jsp">
		<table border="1">
			<tr>
				<td>사번</td>
				<td><input type="text" name="sawon_id"
					
					value="<%=rVO.getSawon_id()%>" readonly></td> <!-- readonly 수정을 못한다 -->
			</tr>
			<tr>
				<td>이름</td>
				<td><input type="text" name="sawon_name"
					value="<%=rVO.getSawon_name()%>"></td>
			</tr>
			<tr>
				<td>휴대폰</td>
				<td><input type="text" name="mobile"
					value="<%=rVO.getMobile()%>"></td>
			</tr>
			<tr>
				<td>이메일</td>
				<td><input type="text" name="email"
					value="<%=rVO.getEmail()%>"></td>
			</tr>
			<tr>
				<td colspan="2"><input type="button" onclick="fn_save()" value="저장"></td>
			</tr>
